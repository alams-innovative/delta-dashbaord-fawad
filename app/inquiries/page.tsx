...
export default function InquiriesPage() {
  ...
  const handleEdit = (inquiry: any) => {
    setEditFormData({
      ...
      gender: inquiry.gender || "", // New field
      matricMarks: inquiry.matricMarks !== null ? String(inquiry.matricMarks) : "", // New field
      outOfMarks: inquiry.outOfMarks !== null ? String(inquiry.outOfMarks) : "", // New field
    })
  ...
  const handleUpdateSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/inquiries/${editingId}`, {
        ...
        body: JSON.stringify({
          ...editFormData,
          matricMarks: editFormData.matricMarks ? Number(editFormData.matricMarks) : null,
          outOfMarks: editFormData.outOfMarks ? Number(editFormData.outOfMarks) : null,
        }),
      })
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="FA IT">FA IT</option> {/* Added FA IT */}
                    </select>
                  </div>
                  {/* New fields for Intermediate */}
                  <div className="space-y-2">
            ...
            {viewingInquiry && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* New display fields for Intermediate */}
                  <div className="space-y-2">
                    <Label className="text-gray-700 font-medium">Gender</Label>
                    <div className="p-3 bg-gray-50 rounded-md border">{viewingInquiry.gender || "Not specified"}</div>
                  </div>
                  <div className="space-y-2">
                    <Label className="text-gray-700 font-medium">Matric Marks</Label>
                    <div className="p-3 bg-gray-50 rounded-md border">
                      {viewingInquiry.matricMarks !== null ? viewingInquiry.matricMarks : "Not provided"}
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label className="text-gray-700 font-medium">Out of Marks</Label>
                    <div className="p-3 bg-gray-50 rounded-md border">
                      {viewingInquiry.outOfMarks !== null ? viewingInquiry.outOfMarks : "Not provided"}
                    </div>
                  </div>
                </div>
                <div className="space-y-2">
