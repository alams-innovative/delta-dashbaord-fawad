...
import { Plus, Search, DollarSign, BarChart3, Loader2 } from "lucide-react"
...
export default function GoogleAdsPage() {
  ...
  useEffect(() => {
    const fetchCampaigns = async () => {
      try {
        const response = await fetch("/api/google-campaigns")
        if (response.ok) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: "Google ads campaign has been added successfully.",
        })
      } else {
        ...
        <Card className="hover-lift border-0 shadow-xl bg-white/80 backdrop-blur-sm max-w-md">
          <CardContent className="pt-8 pb-8">
            <div className="text-center space-y-4">
              <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-r from-yellow-500 to-orange-500 flex items-center justify-center">
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-yellow-50 to-orange-50">
      <div className="p-6 space-y-8">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-yellow-600 to-orange-600 rounded-3xl opacity-10"></div>
          <div className="relative p-8 rounded-3xl">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-lg text-gray-600 mt-1">Track and manage your Google advertising campaigns</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="hover-lift border-0 shadow-xl bg-gradient-to-br from-yellow-500 to-orange-500 text-white">
          ...
          <Card className="hover-lift border-0 shadow-xl bg-white/80 backdrop-blur-sm">
            <CardHeader className="pb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <CardTitle className="text-xl font-bold text-gray-800">Add New Google Campaign</CardTitle>
                  <CardDescription className="text-gray-600">Track a new Google Ads campaign</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-white/50 border-gray-200 focus:border-yellow-400"
                      required
                    />
                  </div>
                  <div className="space-y-2">
        ...
        <Card className="hover-lift border-0 shadow-xl bg-white/80 backdrop-blur-sm">
          <CardHeader className="pb-4">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <CardTitle className="text-xl font-bold text-gray-800">Google Ad Campaigns</CardTitle>
            </div>
            <div className="flex justify-between items-center">
              <CardDescription className="text-gray-600">Track your Google advertising campaigns</CardDescription>
              <Button
                ...
                <Table>
                  ...
                  <TableBody>
                    {campaigns.map((campaign) => (
                      <TableRow key={campaign.id} className="hover:bg-yellow-50/50 transition-colors">
                        ...
                        <TableCell>
                          <div className="w-full bg-gray-200 rounded-full h-2 mb-1">
                            <div
                              ...
                              style={{ width: `${Math.min((0 / Number(campaign.budget)) * 100, 100)}%` }}
                            ></div>
                          </div>
                          <span className="text-xs text-gray-600">
                            {Number(campaign.budget) > 0 ? ((0 / Number(campaign.budget)) * 100).toFixed(1) : 0}%
                          </span>
                        </TableCell>
                      </TableRow>
                    ))}
